...
fun PatcherAPI.patchVoiceChannels() {
    ...
    after<WidgetChannelsListAdapter.ItemVoiceUser>(
        "onConfigure",
        Int::class.java,
    ...
    after<CallParticipantsAdapter.ViewHolderUser>(
        "onConfigure",
        Int::class.java,
...
fun PatcherAPI.patchProfileName(profileTag: Boolean) {
    ...
    after<UserProfileHeaderView>(
        ...
        textView.apply {
            val end = if (guildMember.nick == null && !profileTag) {
...
fun PatcherAPI.patchMemberStatuses() {
    ...
    after<ChannelMembersListViewHolderMember>(
        "bind",
    ...
    after<UserProfileHeaderView>(
        ...
        val guildMember =
            (it.args[0] as UserProfileHeaderViewModel.ViewState.Loaded).guildMember ?: return@after
...
fun PatcherAPI.patchReactionsList() {
    ...
    after<ManageReactionsResultsAdapter.ReactionUserViewHolder>(
        "onConfigure",
        Int::class.java,
        MGRecyclerDataPayload::class.java
    ) {
