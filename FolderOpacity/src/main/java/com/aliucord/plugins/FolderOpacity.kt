...
class FolderOpacity : Plugin() {
    ...
    override fun start(context: Context) {
        ...
        patcher.patch(GuildListViewHolder.FolderViewHolder::class.java.getDeclaredMethod("configure", GuildListItem.FolderItem::class.java), PinePatchFn {
        ...
        // Patch save button
        patcher.patch(`WidgetGuildFolderSettings$configureUI$3`::class.java.getDeclaredMethod("onClick", View::class.java), PinePatchFn {
