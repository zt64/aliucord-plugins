package tk.zt64.plugins.compactmode
...
class PluginSettings(val settings: SettingsAPI): BottomSheet() {
    ...
    override fun onViewCreated(view: View, bundle: Bundle?) {
        ...
        fun addCheckedSetting(title: String, subtext: String, setting: String, default: Boolean = false): CheckedSetting {
        ...
        fun createSeekbar(label: String, setting: String, default: Int, min: Int, max: Int): LinearLayout = LinearLayout(ctx, null, 0, R.i.UiKit_Settings_Item).apply {
