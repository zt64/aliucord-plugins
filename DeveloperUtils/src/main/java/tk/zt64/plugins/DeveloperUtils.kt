...
class DeveloperUtils : Plugin() {
    ...
    companion object {
        val logger = Logger("DeveloperUtils")
    }
    ...
    override fun start(context: Context) {
        ...
        val notificationBuilder =
            NotificationCompat.Builder(context, NotificationClient.NOTIF_GENERAL).setSmallIcon(R.e.ic_security_24dp).setContentTitle("DeveloperUtils").setContentText("Tap to enable inspector")
