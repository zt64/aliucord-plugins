...
fun PatcherAPI.patchMentions() {
    ...
    patch(UserMentionNode::class.java.getDeclaredMethod("renderUserMention", SpannableStringBuilder::class.java, UserMentionNode.RenderContext::class.java), object :
        XC_MethodHook() {
...
fun PatcherAPI.patchReactionsList() {
    ...
    after<ManageReactionsResultsAdapter.ReactionUserViewHolder>("onConfigure", Int::class.java, MGRecyclerDataPayload::class.java) {
        ...
        if (guildMember.color != Color.BLACK) binding.root
