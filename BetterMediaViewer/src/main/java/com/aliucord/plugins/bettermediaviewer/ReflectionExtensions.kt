...
private val controlsAnimatorField: Field = WidgetMedia::class.java.getDeclaredField("controlsAnimator").apply { isAccessible = true }
...
private val mediaSourceField: Field = WidgetMedia::class.java.getDeclaredField("mediaSource").apply { isAccessible = true }
...
private val controlsAnimationActionField: Field = WidgetMedia::class.java.getDeclaredField("controlsAnimationAction").apply { isAccessible = true }
...
private val getToolbarTranslationY: Method = WidgetMedia::class.java.getDeclaredMethod("getToolbarTranslationY").apply { isAccessible = true }
fun WidgetMedia.getToolbarTranslationY() = getToolbarTranslationY.invoke(this) as Float

private val configureAndStartControlsAnimation: Method = WidgetMedia::class.java.getDeclaredMethod("configureAndStartControlsAnimation", ValueAnimator::class.java).apply { isAccessible = true }
