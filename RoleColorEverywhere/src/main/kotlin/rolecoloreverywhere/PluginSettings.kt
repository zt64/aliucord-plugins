...
class PluginSettings(private val settings: SettingsAPI) : BottomSheet() {
    ...
    override fun onViewCreated(view: View, bundle: Bundle?) {
        ...
        addCheckedSetting("Voice users", "Whether usernames in voice channels are colored", "voiceChannel")
        addCheckedSetting("Reaction lists", "Whether usernames on reaction lists are colored", "reactionList")
        addCheckedSetting("Profile name", "Whether usernames on profiles are colored", "profileName")
        addCheckedSetting("Profile name tag", "Whether tags on profiles are colored", "profileTag")
        addCheckedSetting("Statuses", "Whether statuses on sidebars and profiles are colored", "status")
