...
class CategoriesSheetAdapter(private val sheet: BottomSheet, private val channelId: Long, private val categories: List<DMCategory>) : RecyclerView.Adapter<DMCategoryViewHolder>() {
