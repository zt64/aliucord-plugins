...
class PluginSettings(private val settings: SettingsAPI) : BottomSheet() {
    ...
    override fun onViewCreated(view: View, bundle: Bundle?) {
        ...
        addView(Utils.createCheckedSetting(ctx, CheckedSetting.ViewType.SWITCH, "Immersive mode", "Hide the status bar, navigation bar, or both when viewing media").apply {
