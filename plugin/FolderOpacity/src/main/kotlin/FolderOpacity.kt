...
class FolderOpacity : Plugin() {
    ...
    override fun start(context: Context) {
        ...
        patcher.after<GuildListViewHolder.FolderViewHolder>(
            "configure",
            GuildListItem.FolderItem::class.java
        ) {
        ...
        patcher.after<WidgetGuildFolderSettings>(
            "configureUI",
            WidgetGuildFolderSettingsViewModel.ViewState::class.java
        ) {
            ...
            val opacity = settings.getInt(
                "${WidgetGuildFolderSettings.`access$getViewModel$p`(this).folderId}opacity",
                30
            )
