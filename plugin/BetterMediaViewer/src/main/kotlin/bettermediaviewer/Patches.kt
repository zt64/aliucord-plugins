...
object Patches {
    ...
    fun PatcherAPI.patchWidget() {
        ...
        after<WidgetMedia>("onViewBoundOrOnResume") {
            ...
            with(toolbar.menu) {
                findItem(downloadItemId).setOnMenuItemClickListener {
                    val uri = if (isVideo()) {
                        ...
                        Uri.parse(mostRecentIntent.getStringExtra("INTENT_IMAGE_URL"))
                    }
                    ...
                    Utils.threadPool.execute {
                        ...
                        val receiver: BroadcastReceiver = object : BroadcastReceiver() {
                            override fun onReceive(context: Context, intent: Intent) {
                                if (intent.getLongExtra(DownloadManager.EXTRA_DOWNLOAD_ID, -1) ==
                                    reference
                                ) {
                        ...
                        Utils.appActivity.registerReceiver(
                            receiver,
            ...
            if (settings.getBool("bottomToolbar", false) &&
                (!isVideo() && (mediaSource?.l != MediaType.GIFV))
            ) {
                (
                    binding.root
    ...
    fun PatcherAPI.patchControls() {
        ...
        patch(
            WidgetMedia::class.java.getDeclaredMethod("showControls"),
            InsteadHook {
                with(it.thisObject as WidgetMedia) {
                    ...
                    if (controlsAnimationAction == WidgetMedia.ControlsAnimationAction.SHOW) {
                        return@with
                    }
    ...
    fun PatcherAPI.patchToolbar() {
        ...
        after<WidgetMedia>("getToolbarTranslationY") {
            if (mediaSource == null) {
                it.result = -binding.root.findViewById<AppBarLayout>(actionBarId).translationY
            }
        }
    ...
    fun PatcherAPI.patchZoomLimit() {
        patch(
            WidgetMedia::class.java.getDeclaredMethod(
                "getFormattedUrl",
                Context::class.java,
                Uri::class.java
            )
        ...
        for (m in b.c.a.a0.d::class.java.declaredMethods) {
            ...
            if (params.size == 4 &&
                params[0] == b.f.j.d.f::class.java &&
                params[1] == b.f.j.d.e::class.java &&
