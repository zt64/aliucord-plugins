...
class NoBurnIn : Plugin() {
    ...
    override fun start(context: Context) {
        ...
        patcher.patch(WidgetHomeHeaderManager::class.java.getDeclaredMethod("configure", WidgetHome::class.java, WidgetHomeModel::class.java, WidgetHomeBinding::class.java)) {
        ...
        patcher.patch(GuildChannelSideBarActionsView::class.java.getDeclaredMethod("a", *Array(5) { Function1::class.java }, *Array(4) { Boolean::class.java }), PreHook {
            it.args[8] = true
        })
    }
