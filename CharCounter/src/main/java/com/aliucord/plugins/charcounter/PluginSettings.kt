...
class PluginSettings(private val settings: SettingsAPI) : BottomSheet() {
    ...
    override fun onViewCreated(view: View, bundle: Bundle?) {
        ...
        addView(Utils.createCheckedSetting(ctx, CheckedSetting.ViewType.SWITCH, "Reverse", "Whether the counter goes in reverse, counting down how many chars remain").apply {
